 ...
 */
public interface SalesManagerEntityService<K extends Serializable & Comparable<K>, E extends co.hooghly.commerce.domain.SalesManagerEntity<K, ?>> extends TransactionalAspectAwareService{
