...
import co.hooghly.commerce.domain.ShippingOptionPriceType;
import co.hooghly.commerce.domain.ShippingOrigin;
import co.hooghly.commerce.domain.ShippingPackageType;
...
import co.hooghly.commerce.modules.Encryption;
import co.hooghly.commerce.modules.IntegrationException;
import co.hooghly.commerce.modules.shipping.Packaging;
import co.hooghly.commerce.modules.shipping.ShippingQuoteModule;
import co.hooghly.commerce.modules.shipping.ShippingQuotePrePostProcessModule;
import co.hooghly.commerce.startup.ConfigurationModulesLoader;
	...
	public ShippingQuote getShippingQuote(MerchantStore store, Delivery delivery, List<ShippingProduct> products, Language language) throws ServiceException  {
		...
		try {
			...
			try {
				...
				log.error("Error while calculating shipping : " + e.getMessage(), e);
