 ...
 */
@Component
public class ShippingDistancePreProcessor implements ShippingQuotePrePostProcessModule {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ShippingDistancePreProcessor.class);
	...
	public void prePostProcessShippingQuotes(ShippingQuote quote,
		...
		Assert.notNull(apiKey, "Requires the configuration of google apiKey");
