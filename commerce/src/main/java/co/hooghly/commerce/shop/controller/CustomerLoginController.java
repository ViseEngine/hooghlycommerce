...
import co.hooghly.commerce.web.ui.SecuredCustomer;
...
@ConditionalOnProperty(prefix="shop.controller.CustomerLoginController", name="enabled")
public class CustomerLoginController extends AbstractController {
	...
	//http://localhost:8080/commerce/shop/customer/authenticate.html?userName=hooghly&password=password&storeCode=DEFAULT
