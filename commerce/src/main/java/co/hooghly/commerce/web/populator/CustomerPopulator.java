...
import co.hooghly.commerce.web.ui.PersistableCustomerAttribute;
	...
	public Customer populate(PersistableCustomer source, Customer target,
		...
		try {
			...
			if(source.getGender()!=null && target.getGender()==null) {
				target.setGender( co.hooghly.commerce.domain.CustomerGender.valueOf( source.getGender() ) );
			}
			if(target.getGender()==null) {
				target.setGender( co.hooghly.commerce.domain.CustomerGender.M);
			}
