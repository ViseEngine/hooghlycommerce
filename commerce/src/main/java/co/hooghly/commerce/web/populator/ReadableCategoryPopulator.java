...
public class ReadableCategoryPopulator extends
	...
	public ReadableCategory populate(Category source, ReadableCategory target,
		...
		if(source.getDescriptions()!=null && source.getDescriptions().size()>0) {
			...
			if(description!=null) {
				co.hooghly.commerce.web.ui.CategoryDescription desc = new co.hooghly.commerce.web.ui.CategoryDescription();
		...
		if(source.getParent()!=null) {
			co.hooghly.commerce.web.ui.Category parent = new co.hooghly.commerce.web.ui.Category();
