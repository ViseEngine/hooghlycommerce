...
import co.hooghly.commerce.web.ui.CategoryDescription;
...
public class PersistableCategoryPopulator extends
	...
	public Category populate(PersistableCategory source, Category target,
		...
		if(!CollectionUtils.isEmpty(source.getDescriptions())) {
			List<co.hooghly.commerce.domain.CategoryDescription> descriptions = new ArrayList<co.hooghly.commerce.domain.CategoryDescription>();
			for(CategoryDescription description : source.getDescriptions()) {
				co.hooghly.commerce.domain.CategoryDescription desc = new co.hooghly.commerce.domain.CategoryDescription();
