...
public interface ProductOptionValueRepository extends JpaRepository<ProductOptionValue, Long> {
	...
	List<ProductOptionValue> findByStoreId(Long storeId, Integer languageId);
	...
	public List<ProductOptionValue> findByName(Long storeId, String name, Integer languageId);
	...
	public List<ProductOptionValue> findByReadOnly(Long storeId, Integer languageId, boolean readOnly);
