...
import co.hooghly.commerce.business.ProductPriceService;
...
import co.hooghly.commerce.domain.ProductPriceType;
...
public class ProductPriceController {
	...
	private String displayProductPrice(Product product, Long productPriceId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		co.hooghly.commerce.domain.admin.ProductPrice pprice = new co.hooghly.commerce.domain.admin.ProductPrice();
		...
		if(productPriceId!=null) {
			...
			//get default availability
			for(ProductAvailability availability : availabilities) {
				if(availability.getRegion().equals(co.hooghly.commerce.business.Constants.ALL_REGIONS)) {//TODO to be updated when multiple regions is implemented
					productAvailability = availability;
	...
	public String saveProductPrice(@Valid @ModelAttribute("price") co.hooghly.commerce.domain.admin.ProductPrice price, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
