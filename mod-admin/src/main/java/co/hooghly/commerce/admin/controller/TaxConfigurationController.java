...
import co.hooghly.commerce.business.TaxService;
import co.hooghly.commerce.constants.Constants;
import co.hooghly.commerce.domain.MerchantStore;
import co.hooghly.commerce.domain.TaxConfiguration;
...
public class TaxConfigurationController {
	...
	public String displayTaxConfiguration(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return co.hooghly.commerce.admin.controller.ControllerConstants.Tiles.Tax.taxConfiguration;
	}
