...
import co.hooghly.commerce.modules.shipping.CustomShippingQuoteWeightItem;
import co.hooghly.commerce.modules.shipping.CustomShippingQuotesConfiguration;
import co.hooghly.commerce.modules.shipping.CustomShippingQuotesRegion;
...
/*		List<Country> shippingCountries = new ArrayList<Country>();
		...
		List<String> environments = new ArrayList<String>();
		environments.add(co.hooghly.commerce.business.Constants.PRODUCTION_ENVIRONMENT);//only production
