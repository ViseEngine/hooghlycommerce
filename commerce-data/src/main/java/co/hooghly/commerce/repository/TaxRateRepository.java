...
public interface TaxRateRepository extends JpaRepository<TaxRate, Long> {
	...
	List<TaxRate> findByMerchantAndZoneAndCountryAndLanguage(Integer id, Long zoneId, Long countryId, Integer languageId);
	...
	List<TaxRate> findByMerchantAndProvinceAndCountryAndLanguage(Integer id, String province, Long countryId, Integer languageId);
